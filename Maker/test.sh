...
cleos push action $CONTRACT upfeed '["daiqcontract", "1.00 USD", "FUD", "4,EOS"]' -f -p daiqcontract
cleos push action $CONTRACT upfeed '["daiqcontract", "1.00 USD", "FUD", "3,IQ"]' -f -p daiqcontract
cleos push action $CONTRACT upfeed '["daiqcontract", "1.00 USD", "FUD", "2,USD"]' -f -p daiqcontract
...
cleos push action fakeos transfer '["lick", "daiqcontract", "100.0000 EOS", "test"]' -p lick
...
cleos push action everipediaiq transfer '["nick", "daiqcontract", "10000.000 IQ", "test"]' -p nick
cleos push action everipediaiq transfer '["sick", "daiqcontract", "10000.000 IQ", "test"]' -p sick
...
sleep 2
cleos push action $CONTRACT upfeed '["daiqcontract", "0.02 USD", "FUD", "4,EOS"]' -f -p daiqcontract
sleep 2
